...
const Login = () => {
 ...
 const handleSubmit = async (e) => {
  ...
  try {
    ...
    // 🔍 Debug — check what you get
    console.log('Logged in user:', userData);
    console.log('Role:', userData?.role);

    toast.success(`Welcome back, ${userData?.name || 'User'}!`);

    // ✅ Simple check — userData already contains role
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 sm:p-10 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">Sign in to continue your culinary journey</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between mb-2">
                ...
                <Link to="/forgot-password" className="text-amber-400 text-sm hover:text-amber-300 transition-colors">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
            ...
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
                id="remember"
                className="w-4 h-4 rounded border-white/20 bg-white/5 text-amber-500 focus:ring-amber-500/50 cursor-pointer"
              />
